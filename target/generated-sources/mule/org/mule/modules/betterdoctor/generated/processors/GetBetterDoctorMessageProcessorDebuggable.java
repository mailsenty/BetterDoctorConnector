...
public class GetBetterDoctorMessageProcessorDebuggable
    extends GetBetterDoctorMessageProcessor
    implements DebugInfoProvider
{


    public GetBetterDoctorMessageProcessorDebuggable(String operationName) {
        super(operationName);
    }
    ...
    public List<FieldDebugInfo<?>> getDebugInfo(MuleEvent muleEvent) {
        ...
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("gender", "Gender", (java.lang.String.class), gender, muleEvent));
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("specialtyuid", "Specialtyuid", (java.lang.String.class), specialtyuid, muleEvent));
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("last_name", "Last_name", (java.lang.String.class), last_name, muleEvent));
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("location", "Location", (java.lang.String.class), location, muleEvent));
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("first_name", "First_name", (java.lang.String.class), first_name, muleEvent));
