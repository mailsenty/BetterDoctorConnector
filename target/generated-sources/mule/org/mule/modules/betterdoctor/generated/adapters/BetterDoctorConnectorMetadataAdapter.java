...
/**
 * A <code>BetterDoctorConnectorMetadataAdapter</code> is a wrapper around {@link BetterDoctorConnector } that adds support for querying metadata about the extension.
 * 
 */
@SuppressWarnings("all")
@Generated(value = "Mule DevKit Version 3.9.0", date = "2017-09-03T01:24:41-04:00", comments = "Build UNNAMED.2793.f49b6c7")
public class BetterDoctorConnectorMetadataAdapter
    extends BetterDoctorConnectorCapabilitiesAdapter
    implements MetadataAware
{

    private final static String MODULE_NAME = "BetterDoctor";
